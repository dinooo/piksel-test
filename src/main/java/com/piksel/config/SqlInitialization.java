...
@Configuration
@EnableJpaRepositories(basePackages = "com.piksel.persistence")
public class SqlInitialization{
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:postgresql://127.0.0.1:5432/genesisuser");
    ...
    @Bean
        ...
        entityManagerFactoryBean.setPackagesToScan("com.piksel.representations");
